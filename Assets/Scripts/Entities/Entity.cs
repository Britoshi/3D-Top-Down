...
namespace Game
{
  ...
  public class Entity : BritoBehavior, IComparable<Entity>
  {
    ...
    public virtual void Start()
    {
      ...
      chunkCoordinate = GetCurrentCoordinate();
    }
    ...
    public void CoordinateHandler()
    {
      Vec2 newCoord = GetCurrentCoordinate();
      if (!newCoord.Equals(chunkCoordinate)) return;
      //This means its a new coordinate;
      var prevCoord = chunkCoordinate;
      chunkCoordinate = newCoord;
      World.Move(this, prevCoord, newCoord);
    }

    public Vec2 GetCurrentCoordinate()
    {
