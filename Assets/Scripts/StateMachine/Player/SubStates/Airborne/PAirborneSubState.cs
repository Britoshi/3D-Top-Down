...
{
    public class PAirborneSubState : PAirborneSubStateBase, IHasAnimation
    {
        public virtual string GetAnimationName() => "Airborne";

        public PAirborneSubState(PStateMachine currentContext, PStateFactory playerStateFactory, BaseState superState) :
